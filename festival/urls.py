...
urlpatterns = [
    ...
    path(_('clanky/'), views.ArticleListView.as_view()),
    path(_('clanky/<slug:slug>/'), views.ArticleDetailView.as_view()),
    ...
    path('pay-registration/<int:pk>/<slug:film_name>/', views.AlterPayFilmRegistrationView.as_view()),
